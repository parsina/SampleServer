...
import com.coin.app.security.CustomUserDetailsService;
import com.coin.app.security.JwtAuthenticationEntryPoint;
import com.coin.app.security.JwtAuthenticationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/", "/auth/**", "/confirm/**", "/form/**").permitAll().and()
